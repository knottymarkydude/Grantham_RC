    ...
    <body>
        ...
        <div id="wrapper" class="container-fluid">
            ...
            <div class="row-fluid " >
                ...
                <div class="span4">
                    <div class="thumbnail"><a href="../images/mom/201309_large.jpg" rel="image" title="Gwenda Williams"><img class="img-polaroid" src="../images/mom/201309_large.jpg" alt="Gwenda Williams" /><div class="image-overlay-zoom"></div></a></div>
                </div>
            </div>
            <!-- Wrapper / End -->
            <!-- Footer   -->
